...
import pandas as pd, numpy as np, app.vendor.plspm.util as util
from sklearn.decomposition import PCA
from app.vendor.plspm.config import Config
from app.vendor.plspm.mode import Mode

class Unidimensionality:
    """Internal class that computes various reliability metrics. Use the method :meth:`~.app.vendor.plspm.Plspm.unidimensionality` defined on :class:`~.app.vendor.plspm.Plspm` to retrieve the results."""
