...
class OuterModel:
    """Internal class that computes characteristics of the outer model.  Use the methods :meth:`~.app.vendor.plspm.Plspm.outer_model` and :meth:`~.app.vendor.plspm.Plspm.crossloadings` defined on :class:`~.app.vendor.plspm.Plspm` to retrieve the outer model characteristics."""
